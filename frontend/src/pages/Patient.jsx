...
const Patient = () => {
  ...
  const handleRevokeProthesisCancel = async (prothesis) => {
    if (!assertPatientEditable()) return;
    try {
      setBusyProthesisStatusId(prothesis.id);
      await revokeCancelProthetics(prothesis.id);
                      ...
                      {cancelled ? (
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <button
                            type="button"
                            className="action-btn cancel"
                            onClick={() => handleRevokeProthesisCancel(p)}
